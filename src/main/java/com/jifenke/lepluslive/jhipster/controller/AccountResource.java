...
import com.jifenke.lepluslive.jhipster.repository.PersistentTokenRepository;
...
import com.jifenke.lepluslive.jhipster.controller.dto.KeyAndPasswordDTO;
import com.jifenke.lepluslive.jhipster.controller.dto.UserDTO;
...
public class AccountResource {
    ...
    public ResponseEntity<UserDTO> getAccount() {
        ...
        return new ResponseEntity(new UserDTO(username, currentUser.getAuthorities().stream().map(GrantedAuthority::getAuthority).collect(
