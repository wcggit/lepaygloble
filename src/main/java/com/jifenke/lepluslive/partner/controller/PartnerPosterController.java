...
public class PartnerPosterController {
    ...
    public void downLoadPoster(HttpServletResponse response,
        ...
        String
            qrCodeUrl =
            "https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=" + merchant.getMerchantInfo()
                .getTicket();                        // 海报二维码
        ...
        try {
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    int
                        x1 =
                        new Long(Math.round((backImage.getWidth() - qrWidth) * 0.5)).intValue();
                    int
                        y1 =
                        new Long(Math.round((backImage.getHeight() - qrHeight) * 0.79)).intValue();
                    lock.lock();
            ...
            final String finalHeadImageUrl = headImageUrl;
            new Thread(() -> {
                InputStream headImageIns = ImageLoad.returnStream(finalHeadImageUrl); //  头像
                try {
                    ...
                    cutHeadImage =
                        g2.getDeviceConfiguration().createCompatibleImage(headImage.getWidth(),
                                                                          headImage.getHeight(),
                    ...
                    int
                        x2 =
                        new Long(Math.round((backImage.getWidth() - hdWidth) * 0.55)).intValue();
