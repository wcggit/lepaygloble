...
public class StatsMerDailyDataService {
    ...
    public List<Map<String, Object>> list(StatsMerDailyDataCriteria criteria, int pageSize) {
        String sql = "SELECT m.id mid,m.merchant_sid sid ,m.user_limit bindLimit,m.`name` AS merchantName,mu.`merchant_name` AS ownerMerchant,m.partnership AS partnership,m.lj_commission AS ljCommission," +
