...
import com.jifenke.lepluslive.security.*;
import com.jifenke.lepluslive.global.filter.CsrfCookieGeneratorFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        auth.authenticationProvider(superAdminOnlyAuthenticationProvider())
    ...
    protected void configure(HttpSecurity http) throws Exception {
        SecurityContextRepository
            SecurityContextRepository =
            new LeJiaSecurityContextRepositoryImpl();
        http
            .csrf()
            .ignoringAntMatchers("/websocket/**")
            .and()
            .addFilterAfter(leJiaAuthenticationFilter(), SecurityContextPersistenceFilter.class)
