...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "lepaygloble@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "lepaygloble API";

        private String description = "lepaygloble API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "lepaygloble";
