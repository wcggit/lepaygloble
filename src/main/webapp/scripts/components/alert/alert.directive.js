        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('lepayglobleApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-lepayglobleApp-error');
                                var entityKey = httpResponse.headers('X-lepayglobleApp-params');
                                if (errorHeader) {
